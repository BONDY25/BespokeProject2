...
namespace BespokeProject_2
{
    internal class SessionMaintenance
    {
        ...
        public static Color accentColor = Color.Yellow;
        public static Color backColor = Color.White;
        public static Color foreColor = Color.Black;

        public static string currentVersion = "2.2.16"; // Current Version of the Application
        public static string appName = "BespokeProject"; //Name of the Application
        ...
        public static void CheckVersion()
        {
            ...
            string query = $"SELECT TOP 1 [Version] FROM VERSION_CTRL WHERE [Application] = '{appName} 2' ORDER BY Last_Updated DESC";
